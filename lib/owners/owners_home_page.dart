...
class _OwnersHomePageState extends State<OwnersHomePage> with RouteAware, WidgetsBindingObserver {
  ...
  Future<List<OrderData>> loadOrders() async {
    final snapshot = await FirebaseDatabase.instance.ref().child('orders').get();
    ...
    ownerOrders.sort((a, b) {
      ...
      if (statusComparison != 0) {
        ...
        return a.orderTimeTaken.compareTo(b.orderTimeTaken);
      }
    });
                ...
                children: [
                  OrderCardOwners(
                    ...
                    press: () {
                      ...
                      String orderTime = ownerOrders[index].orderTimeTaken.toDate().toString().split('.')[0];
                      if (orderID.isEmpty) {
                        orderID = 'No driver';
                      }
          ...
          child: RefreshIndicator(
            ...
            child: StreamBuilder<DatabaseEvent>(
              ...
              builder: (context, snapshot) {
                ...
                isButtonDisabled = requestDriverCheck.shouldDisableButton(ownerOrders);
                return buildOrderList(ownerOrders);
              },
            ),
          ),
        ),
